(function( $ ) {
	...
	$.fn.lionbars = function(options) {
		...
		function resizeMainBox(elem) {
			var el = $(elem);
      // TODO: remember that I removed added padding as fix
			el.css({ "width" : el.width(), "height" : el.height() + paddingTop + paddingBottom });
      // TODO: find better place to put this
      el.find('.lb-content').css("padding-right", paddingRight);
		}
